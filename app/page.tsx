  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto flex min-h-[calc(100vh-80px)] max-w-6xl flex-col items-center justify-center px-4 py-10 text-center md:px-8">
        ...
        <p className="mt-5 text-base font-semibold text-brand">7 Days Free Trial → Then ₦2,000/month</p>
        <p className="text-sm text-slate-500">Start your free trial now</p>
        <Link href="/signup" className="mt-8 inline-flex rounded-full bg-brand px-8 py-3 text-white shadow-lg transition hover:bg-blue-500">Start Free Trial</Link>
      </main>
    </div>
  );
}
